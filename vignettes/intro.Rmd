---
title: "Getting Started with imagerExtra-lixinrui"
author: "Shota Ochi"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with imagerExtra-lixinrui}
...
imagerExtra-lixinrui provides advanced functions for image processing based on the R package imager.

The functions in imagerExtra-lixinrui are classified into 4 groups by their functions.
...
See below to know what functions imagerExtra-lixinrui provides.

<br />

## Preparation

Most of the functions in imagerExtra-lixinrui are for grayscale image.

See the vignette Treating Color Image with imagerExtra-lixinrui if you want to treat color image with imagerExtra-lixinrui.

Let's prepare grayscale images.

```{r, fig.width=5, fig.height=5, message=FALSE}
library(imagerExtra-lixinrui)
g <- grayscale(boats)
gd <- grayscale(dogs)
...
These functions are for treating color image with imagerExtra-lixinrui.

See the vignette Treating Color Image with imagerExtra-lixinrui for detail.

### OCR and OCR_data

These functions are wrappers for ocr function and ocr_data function of the R package tesseract.

See the vignette Optical Character Recognition with imagerExtra-lixinrui for detail.
